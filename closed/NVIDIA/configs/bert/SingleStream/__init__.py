...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class RTX_2080_Tix1(BenchmarkConfiguration):
    system = System("GeForce RTX 2080 Ti", Architecture.Turing, 1)
    bert_opt_seqlen = 270
    coalesced_tensor = True
    gpu_batch_size = 1
    gpu_copy_streams = 1
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class Quadro_RTX_8000x1(BenchmarkConfiguration):
    system = System("Quadro RTX 8000", Architecture.Turing, 1)
    bert_opt_seqlen = 270
    coalesced_tensor = True
    gpu_batch_size = 1
    gpu_copy_streams = 1
